            ...
            <section className="row mt-3">
                ...
                <main className="col-8 d-flex flex-wrap overflow-auto" style={{height:'600PX'}}>
                    {
                        products.map(product=>
                            <div key={product.id} className="card m-2 p-2 w-25">
                                ...
                                <div className="card-header" style={{heigh:'160px'}}>
                                    <p>{product.title}</p>
                ...
                <aside className="col-2">
                    <button className="btn btn-warning w-100">
                        <span className="bi bi-cart4 "></span>[{itemsCount}]Your CartItems
                        </button> 
                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Price</th>
                                    <th>Preview</th>
                                    <th><button className="btn btn-danger">Empty</button></th>
                                </tr>
                            </thead>
                            <tbody>
                                {
                                    cartItems.map(item=>
                                        <tr key={itemsCount.id}>
                                            ...
                                            <td>
                                                <button className="btn btn-danger">
                                                    <span className="bi bi-trash">D</span>
                                                </button>
                                            </td>
